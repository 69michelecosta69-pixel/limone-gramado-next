    ...
    <main className="section-spacing">
      <section className="container-limone surface-card p-6 md:p-10">
        ...
        <p className="mt-4 text-[var(--muted)]">
          ...
          nadando na água azul do Mediterrâneo. Aquele momento sempre trazia uma sensação de alegria e expectativa,
          porque eu sabia que logo chegaríamos à casa da minha avó, onde toda a família nos esperava.
        </p>

        <p className="mt-4 text-[var(--muted)]">
          A mesa era grande, sempre cheia de gente, e depois das refeições vinha um pequeno ritual: um copo de
          limoncello servido com carinho, acompanhado de conversas que pareciam nunca terminar.
        </p>

        <p className="mt-4 text-[var(--muted)]">
          Com o tempo, essa memória de família virou inspiração. Decidi transformar aquela tradição em algo que eu
